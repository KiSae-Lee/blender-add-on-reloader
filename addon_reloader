...
bpy.types.Scene.reload_lib_name = bpy.props.StringProperty(
...
class ReloadPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.label(text=f"Target: {context.scene.reload_lib_name}")
...
class ReloadOperator(bpy.types.Operator):
    ...
    def execute(self, context):
        addon_name = context.scene.reload_lib_name
